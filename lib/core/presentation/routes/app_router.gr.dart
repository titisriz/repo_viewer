  ...
  final Map<String, _i7.PageFactory> pagesMap = {
    ...
    RepoDetailRoute.name: (routeData) {
      ...
      return _i7.MaterialPageX<dynamic>(
          routeData: routeData,
          child:
              _i6.RepoDetailPage(key: args.key, githubRepo: args.githubRepo));
    }
  };
...
class RepoDetailRoute extends _i7.PageRouteInfo<RepoDetailRouteArgs> {
  RepoDetailRoute({_i8.Key? key, required _i9.GithubRepo githubRepo})
      : super(RepoDetailRoute.name,
            path: '/detail',
            args: RepoDetailRouteArgs(key: key, githubRepo: githubRepo));

  static const String name = 'RepoDetailRoute';
}

class RepoDetailRouteArgs {
  const RepoDetailRouteArgs({this.key, required this.githubRepo});

  final _i8.Key? key;

  final _i9.GithubRepo githubRepo;

  @override
  String toString() {
    return 'RepoDetailRouteArgs{key: $key, githubRepo: $githubRepo}';
  }
}
